...
sys.path.append('..')
xurl = "https://heiliaowang150.buzz"
headerx = {
...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        result = {}
        result['class'] = []
        result['class'].append({'type_id': "/type/158", 'type_name': "国产传媒"})
        result['class'].append({'type_id': "/type/161", 'type_name': "精品资源"})
        result['class'].append({'type_id': "/type/246", 'type_name': "精品仓库"})
        result['class'].append({'type_id': "/type/316", 'type_name': "特色资源"})
        result['class'].append({'type_id': "/type/164", 'type_name': "VR视角"})
        for item in vod:
        ...
        if '"rid"' in res.text:
            ...
            while not decoded_str:
                ...
                if source_match3:
                    ...
                    res2 = requests.post(url="https://heiliaowang150.buzz/fetchPlayUrl3", headers=header, data=data)
